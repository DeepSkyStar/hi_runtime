...
void hi_buffer_clear_begin(hi_buffer_t *buffer);

uint8_t* hi_buffer_begin(hi_buffer_t *buffer);
uint8_t* hi_buffer_last(hi_buffer_t *buffer);
hi_size_t hi_buffer_length(hi_buffer_t *buffer);
hi_size_t hi_buffer_remain(hi_buffer_t *buffer);
